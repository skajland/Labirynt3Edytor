...
namespace Labirynt_3_Edytor.scripts{
    ...
    internal static class BlockSpawn{
        ...
        {   new Block(Raylib.LoadImage(Program.DataDir + "res/blocks/grass.png"), new Vector2(86,86),1, 1, "B", 0),
            ...
            new Block(Raylib.LoadImage(Program.DataDir + "res/enemy.png"), new Vector2(104,124), 12, 5, "E", 0),
            new Block(Raylib.LoadImage(Program.DataDir + "res/blocks/TurretBase.png"), new Vector2(86,86), 13, 2, "BI", 0),        
            new Block(Raylib.LoadImage(Program.DataDir + "res/blocks/Lava.png"), new Vector2(86,86), 14, 1, "B", 0),      
            ...
            new Block(Raylib.LoadImage(Program.DataDir + "res/enemyRound.png"), new Vector2(72,92), 21, 5, "E", 4),
            new Block(Raylib.LoadImage(Program.DataDir + "res/enemyTriangle.png"), new Vector2(86,110), 22, 5, "E", 2),
            new Block(Raylib.LoadImage(Program.DataDir + "res/blocks/netherack.png"), new Vector2(86,86), 23, 1, "B", 0),
